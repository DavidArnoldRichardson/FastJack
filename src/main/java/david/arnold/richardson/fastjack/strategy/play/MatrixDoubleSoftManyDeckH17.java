...
public class MatrixDoubleSoftManyDeckH17 extends Matrix {

    public MatrixDoubleSoftManyDeckH17() {
        table = new PlayerDecision[][]{
                //A    2    3    4    5    6    7    8    9    T
                {n_a, n_a, n_a, n_a, DBL, DBL, n_a, n_a, n_a, n_a}, // 2
                {n_a, n_a, n_a, n_a, DBL, DBL, n_a, n_a, n_a, n_a}, // 3
                {n_a, n_a, n_a, DBL, DBL, DBL, n_a, n_a, n_a, n_a}, // 4
                {n_a, n_a, n_a, DBL, DBL, DBL, n_a, n_a, n_a, n_a}, // 5
                {n_a, n_a, DBL, DBL, DBL, DBL, n_a, n_a, n_a, n_a}, // 6
                {n_a, DBL, DBL, DBL, DBL, DBL, n_a, n_a, n_a, n_a}, // 7
