...
public class MatrixDoubleHardManyDeckS17 extends Matrix {

    public MatrixDoubleHardManyDeckS17() {
        table = new PlayerDecision[][]{
                ...
                {n_a, n_a, DBL, DBL, DBL, DBL, n_a, n_a, n_a, n_a}, // 9
                {n_a, DBL, DBL, DBL, DBL, DBL, DBL, DBL, DBL, n_a}, // 10
                {n_a, DBL, DBL, DBL, DBL, DBL, DBL, DBL, DBL, DBL}, // 11
