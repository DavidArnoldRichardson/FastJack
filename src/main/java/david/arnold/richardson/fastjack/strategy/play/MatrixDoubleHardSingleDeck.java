...
public class MatrixDoubleHardSingleDeck extends Matrix {

    public MatrixDoubleHardSingleDeck() {
        table = new PlayerDecision[][]{
                ...
                {n_a, n_a, n_a, n_a, DBL, DBL, n_a, n_a, n_a, n_a}, // 8
                {n_a, DBL, DBL, DBL, DBL, DBL, n_a, n_a, n_a, n_a}, // 9
                {n_a, DBL, DBL, DBL, DBL, DBL, DBL, DBL, DBL, n_a}, // 10
                {DBL, DBL, DBL, DBL, DBL, DBL, DBL, DBL, DBL, DBL}, // 11
