...
public class MatrixDoubleSoftDoubleDeckH17 extends Matrix {

    public MatrixDoubleSoftDoubleDeckH17() {
        table = new PlayerDecision[][]{
                //A    2    3    4    5    6    7    8    9    T
                {n_a, n_a, n_a, n_a, n_a, n_a, n_a, n_a, n_a, n_a}, // 2: A,A
                {n_a, n_a, n_a, n_a, DBL, DBL, n_a, n_a, n_a, n_a}, // 3: A,2
                {n_a, n_a, n_a, DBL, DBL, DBL, n_a, n_a, n_a, n_a}, // 4: A,3
                ...
                {n_a, DBL, DBL, DBL, DBL, DBL, n_a, n_a, n_a, n_a}, // 8: A,7
                {n_a, n_a, n_a, n_a, n_a, DBL, n_a, n_a, n_a, n_a}, // 9: A,8
